...
const { sanitizeValue, parseJsonField, extractCreditCardLast4 } = require('../utils/userHelpers');
...
const buildLookups = () => {
  ...
  return { genders, hobbies, techInterests, states, cities, citiesByState };
};
...
const downloadExcelTemplate = (pool) => async (req, res) => {
  try {
    ...
    writeList(6, 'Cities', lookups.cities);
